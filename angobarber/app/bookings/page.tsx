  ...
  return (
    ...
    {/************************************* BOOKINGS DETAILS CONFIRMED ***************************************/}
      <div className="p-5 space-y-3">
        ...
        <h2 className="mb-2 mt-6 text-xs font-bold uppercase text-gray-400">Confirmados</h2>
        {confirmedbookings.map(booking => (
            <Agendamento key={booking.id} booking={booking} />
        ))}

        {/************************************ BOOKINGS DETAILS NOT CONFIRMED*************************************/}
        <h2 className="mb-2 mt-6 text-xs font-bold uppercase text-gray-400">Finalizados</h2>
